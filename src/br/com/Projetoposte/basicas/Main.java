...
//Neste teste, irei criar postes, arestas e o grafo. Depois irei testar de fato o algoritmo		
		Poste poste1 = new Poste(1, 2, 2);
		Poste poste2 = new Poste(2, 2, 2);
		Poste poste3 = new Poste(3, 2, 2);
